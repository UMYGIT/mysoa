...
import com.soap.annotation.SystemLog;
import com.soap.entity.LogFormMap;
import com.soap.mapper.LogMapper;
...
public  class LogAopAction {
    //本地异常日志记录对象
     ...
     //Controller层切点
    @Pointcut("@annotation(com.soap.annotation.SystemLog)")
